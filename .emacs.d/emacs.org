...
#+begin_src emacs-lisp
  ...
  ;; some stuff for window management
  (use-package shackle
    :ensure t
    :init
    (setq shackle-rules
          '(
            (compilation-mode :noselect t :align 'bottom :size 0.3)
            ("*Warnings*" :ignore t)
            ("*Async Shell Command*" :ignore t)
            (mu4e-main-mode :select t :same t)))
    :config
    (shackle-mode 1))

  (use-package popper
    :ensure t ; or :straight t
    :bind (("<f11>"   . popper-toggle)
  				 ("<f12>"   . popper-cycle))
    :init
  ...
  (setq transient-display-buffer-action
        '(display-buffer-in-side-window (side . bottom) (slot . -1) (dedicated . t) (inhibit-same-window . t)))
#+end_src
...
#+begin_src emacs-lisp
  ...
  (setq flymake-firnge-indicator-position 'right-fringe)																			;
#+end_src
** claude-code
#+begin_src emacs-lisp
  (use-package claude-code-ide
    ...
    (setq claude-code-ide-cli-extra-flags "--model qwen3.6")) 
#+end_src
...
#+begin_src emacs-lisp
  ...
  (use-package cmake-integration
    :vc (:url "https://github.com/darcamo/cmake-integration.git"
              :rev :newest)
    :bind ("C-x c" . cmake-integration-transient))
#+end_src
** direnv
#+begin_src emacs-lisp
  (use-package direnv
