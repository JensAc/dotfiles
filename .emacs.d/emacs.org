                ...
                (delete nil `( ,(make-mu4e-context
                     ...
                     :vars '( ( user-mail-address	   . "jens.schneider.ac@posteo.de"  )
                              ...
                              (mu4e-maildir-shortcuts . ( ("/posteo/Inbox"   . ?i)
                                                          ...
                                                          ("/posteo/Trash"   . ?t)
                                                          ("/posteo/Drafts"   . ?d) ))))
                ,(if (acemacs/is-nunc) (make-mu4e-context
                     :name "23Tec"
...
Amtsgericht: Stuttgart, HRB 776151")
  ...
  www.ient.rwth-aachen.de")
          ...
          ;; work with mbsync
          (if (acemacs/is-nunc) (setq mu4e-get-mail-command "mbsync 23Tec posteo") (setq mu4e-get-mail-command "mbsync posteo ient rwth"))
